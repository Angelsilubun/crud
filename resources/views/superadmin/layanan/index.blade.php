...
<div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/superadmin/layanan/simpan')}}" method="POST" enctype="multipart/form-data">
                @method("PUT")
                @csrf
    ...
    <div class="modal-dialog modal-lg" style="width: 40%">
        <div class="modal-content">
            <div class="modal-header hader text-center">
                <h3 class="modal-title" id="exampleModalLabel">Detail Profil</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<script type="text/javascript">
    ...
    function editLayanan(id) {
        $.ajax({
            url: "{{ url('/superadmin/layanan/edit') }}",
            type: "GET",
            data: {
                id: id
            },
    ...
    {
        $.ajax({
            url: "{{ url('/superadmin/layanan/detail') }}",
            type: "GET",
            data: {
                id:id
            },
